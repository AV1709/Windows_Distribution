...
function check_collapse(){
    hideA = 0
    for (let i = 1; i<9; i++) {
        if (document.getElementById(String(Number(i*10))+'_unnotice').checked == true) {
            hideA++
        }
    }
    if (hideA==8) {
        if (document.getElementById('bodyA').classList.contains('show')){
            document.getElementById("collapse_2a").click()
        }
    } else if (!document.getElementById('bodyA').classList.contains('show')){
        document.getElementById("collapse_2a").click()
    }
    ...
    if (hideB==9) {
        if (document.getElementById('bodyB').classList.contains('show')){
            document.getElementById("collapse_2b").click()
        }
    } else if (!document.getElementById('bodyB').classList.contains('show')){
        document.getElementById("collapse_2b").click()
    }
    ...
    if (hideC==12) {
        if (document.getElementById('bodyC').classList.contains('show')){
            document.getElementById("collapse_2c").click()
        }
    } else if (!document.getElementById('bodyC').classList.contains('show')){
        document.getElementById("collapse_2c").click()
    }
